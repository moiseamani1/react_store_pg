...
import {Grid,Typography,List,ListItem,Button,CardMedia,CircularProgress} from '@material-ui/core'
...
<div className={classes.gridSection}>
            ...
            <Typography variant="h6" >Colour: {product.name.split(" ").pop().toUpperCase()}</Typography>
            </div> 
            ...
            <div>  <Button  className={classes.button} variant="contained" color="primary" size={'large'} onClick={()=>addToCart(product.id,1)}  >
                      Add to Cart
                    </Button></div>  
